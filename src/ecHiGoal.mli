...
val process_mintros     : ?withbd:bool -> ?cf:bool -> ttenv -> intropattern list -> tactical
val process_mgenintros  : ?withbd:bool -> ?cf:bool -> ttenv -> introgenpattern list -> tactical
